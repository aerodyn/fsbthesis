...
\usepackage[cp1250]{inputenc} %s ovim mogu pisati hrv znakove direktno!
\usepackage{amsmath}
...
%
\ifpdf %ako radim pdf netrebaju mi korice	
	\relax
\else
\fsbkorice
\fi
...
\begin{izjava}
	Izjavljujem da sam ovaj rad radio samostalno koriste\' ci ste\v cena
...
Malo æu se pozvati (\eqref{eq:ls-a1}) kao u šðèæžŠÐÈÆŽ na 
...
\nomenclature[Ks]{$SUZ$}{Sveuèilište u Zagrebu}%
