...
\usepackage[zavrsni,avant]{fsbthesis}
	...
	% ... za opis svih opicija pogledaj fsbthesis-doc.txt i fsbthesis.sty 
...
%\hypersetup{colorlinks=false} % za print-verziju teksta bez obojanih linkova u pdf-u
...
\begin{abstract}
  ...
  to one page in single paragraph \ldots Tekst tekst tekst tekst tekst tekst.
\end{abstract}
